...
export class ListContainer {
  items = [
    ...
    {id: '3', value: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem voluptates odit molestiae repellendus, minus deserunt.'}
  ];
  ...
  updateIntention(targetId, beforeTarget) {
    ...
    if (this.intention) {
      ...
      originalIndex = _.findIndex(patchedItems, {id: this.dnd.model.id});
